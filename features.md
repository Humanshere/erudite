...
- [ ] Enrollment/roll number generation
...
- [ ] Certificate generation (bonafide/transcript/etc.)
...
- [ ] Submit assignments
- [ ] View marks/results/grade card
- [ ] Pay fees and download receipts
- [ ] Apply for leave
- [ ] Raise service/helpdesk requests
...
- [ ] Placement and internship module
...
- [ ] Basic test coverage (backend + frontend)
